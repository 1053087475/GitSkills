                ...
                <div class="card margin-bottom-no">
                    <div class="card-main">
                        <div class="card-inner">
                            <div class="card-inner">
                            	<form action="${pageContext.request.contextPath}/updateWorkerAllInfo.do" method="post">
								<input type="hidden" name="eid" readonly =“readonly” value="${w.eid }"/>
                                <div class="cardbtn-edit">
							    	...
							    	<table class="a">
							            ...
							            <tr>
							            	<td>职工号：</td>
							                <td><input style="text-align:left" type="text" value="${w.eid}" name="eid" id="eid"></td>
							                
							            </tr>
							            <tr>
							            	<td>姓名：</td>
							            	<td><input style="text-align:left" type="text" value="${w.name}" name="name" id="name"></td>
							            </tr>
							            <tr>
							            	<td>性别：</td>
							                <td><input style="text-align:left" type="text" value="${w.sex}" name="sex" id="sex"></td>
							            </tr>
							            <tr>
							            	<td>民族：</td>
							            	<td><input style="text-align:left" type="text" value="${w.nation}" name="nation" id="nation"></td>
							            </tr>
							            <tr>
							            	<td>证件类型：</td>
							            ...
							            <tr>
							            	<td>身份证号：</td>
							            	<td><input style="text-align:left" type="text" value="${w.id_number}" name="id_number" id="id_number"></td>
							            </tr>
							            <tr>
							            	<td height=30px>出生日期：</td>
							                <td><input style="text-align:left" type="date" value="${w.birth}" name="birth" id="birth"></td>
							            </tr>
							            <tr>
							            	<td height=30px>受教育情况：</td>
							            	<td>
							            	<select name="education" id="education">
							                    <option value="${w.education}" style="visibility:hidden" >${w.education}</option>
							            ...
							            <tr>
							                ...
							                <td><select name="is_single" id="is_single">
							                    <option value="${w.is_single}" style="visibility:hidden" >${w.is_single}</option>
								...
								<table class="a">
							        <tr>
							            <td>所在部门：</td>
							            <td><input style="text-align:left" type="text" value="${w.dpname}" name="dpname" id="dpname"></td>
							        </tr>
							        <tr>
							        	<td>职位：</td>
							        	<td><input style="text-align:left" type="text" value="${w.position}" name="position" id="position"></td>
							        </tr>
							        <tr>
							            <td>入职时间：</td>
							            <td><input style="text-align:left" type="date" value="${w.entry_time}" name="entry_time" id="entry_time"></td>
							        </tr>
							    </table>
							    ...
							    <table>
							    	<tr>
							    		...
							    		<td width=500px><input style="text-align:left" type="text" value="${w.phone}" name="phone" id="phone"></td>
							    	</tr>
							    	<tr>
							    		<td>E-mail：</td>
							    		<td><input style="text-align:left" type="text" value="${w.mail}" name="mail" id="mail"></td>
							    	</tr>
							    	<tr>
							    		<td>家庭地址：</td>
							    		<td><input style="text-align:left" type="text" value="${w.address}" name="address" id="address"></td>
							    	</tr>
							    </table>
							    </form>
                            </div>
