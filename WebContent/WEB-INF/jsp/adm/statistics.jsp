...
<main class="content">
    ...
    <div class="content-header ui-content-header" style="background-image:url('img/amber.jpg')">
        <div class="container">
            <h1 class="content-heading">统计中心</h1>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="card user-info">
                        <div class="user-info-main">
                            <div class="nodemain">
                                <div class="nodehead node-flex">
                                    <div class="nodename">男性人数</div>
                                </div>
                                <div class="nodemiddle node-flex">
                                    <div class="nodetype">
                                        <dd>${statistics.male }人</dd>
                                    </div>
                        ...
                        <div class="user-info-bottom">
                            <div class="nodeinfo node-flex">
                                <span>点击查看男性职工→</span>
                                <form action="${pageContext.request.contextPath}/findWorkerBySex.do" method="post" id="findMaleWorker" style="margin:0px;">
                                	<input type="hidden" name="sex" readonly =“readonly” value="男"/>
                           			<a href="javascript:document:findMaleWorker.submit();" class="card-tag tag-green" one-link-mark="yes">查看</a>
                            	</form>
                ...
                <div class="col-xx-12 col-xs-6 col-lg-3">
                    <div class="card user-info">
                        ...
                        <div class="user-info-bottom">
                            <div class="nodeinfo node-flex">
                                <span>点击查看女性职工→</span>
                                <form action="${pageContext.request.contextPath}/findWorkerBySex.do" method="post" id="findFemaleWorker" style="margin:0px;">
                                	<input type="hidden" name="sex" readonly =“readonly” value="女"/>
                           			<a href="javascript:document:findFemaleWorker.submit();" class="card-tag tag-green" one-link-mark="yes">查看</a>
                            	</form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xx-12 col-xs-6 col-lg-3">
                    <div class="card user-info">
                        ...
                        <div class="user-info-bottom">
                            <div class="nodeinfo node-flex">
                                <span>点击查看单身职工→</span>
                                <form action="${pageContext.request.contextPath}/findWorkerByIs_single.do" method="post" id="findSingleWorker" style="margin:0px;">
                                	<input type="hidden" name="is_single" readonly =“readonly” value="是"/>
                           			<a href="javascript:document:findSingleWorker.submit();" class="card-tag tag-green" one-link-mark="yes">查看</a>
                            	</form>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xx-12 col-xs-6 col-lg-3">
                    <div class="card user-info">
                        <div class="user-info-main">
                            <div class="nodemain">
                                <div class="nodehead node-flex">
                                    <div class="nodename">男女比例</div>
                                </div>
                                <div class="nodemiddle node-flex">
                                    <div class="nodetype">
                                          ${male_scale }:${female_scale }
                                    </div>
                                </div>
